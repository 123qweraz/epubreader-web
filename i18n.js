...
const I18N_STRINGS = {
  zh: {
    ...
    closeBook: "关闭书籍", exportImages: "提取本书图片",
    /* 设置面板 */
    ...
    pinyinLabel: "外挂注音", pinyinAria: "注音模式", annOff: "关", annPinyin: "拼音", annRomaji: "罗马音", annPyOnly: "纯拼音", pinyinSessionTip: "拼音为汉字标注，罗马音为日语假名标注（书内假名注音一并转换），纯拼音直接用拼音替换汉字正文；不影响书籍原生注音的显示。开启状态不做持久化，每次打开应用需重新开启。", pinyinNativeRuby: "本书自带注音，外挂注音不会覆盖已有注音", pinyinLoadFail: "注音库加载失败, 请检查网络后重试",     pinyinTooLong: "文本过长, 部分内容已跳过拼音标注", twTip: "打字模式: 只按字母键(英文打单词·中文打拼音·日文打罗马音), 打字驱动阅读; Esc退出 Tab跳词", twAria: "打字模式", twNoVert: "竖排暂不支持打字模式", twPickHint: "点击一段文字开始打字（Esc 退出）", twBarHint: "打字中", twPh: "在此输入字母…", twChapDone: "本章打完，已到末尾", twStatPick: "请点击段落开始打字", twModeLabel: "中文打字方式", twModeAria: "中文打字方式", twModePinyin: "拼音对照", twModeReal: "输入法真打", twModeHint: "拼音对照：关闭输入法按拼音字母逐键对比；输入法真打：正常用输入法打字上屏，按上屏汉字与原文比对，英文直接照打。", sndLabel: "打字音效", sndAria: "打字音效开关", sndTip: "打字模式下按键播放声音, 打错播放错误提示音", sndHint: "打字模式下按键播放打字声，打错播放错误提示音；偏好会保存并随备份导出。", mkTip: "马克笔高亮: 开启后划选正文即标记, 点已有高亮可删除", mkAria: "马克笔高亮", mkDel: "删除这条高亮?", mkDeleted: "高亮已删除", bookFontAria: "书籍字体优先", chapFailTitle: "本章无法显示", chapFailBody: "该章节文件缺失或已损坏，其余章节不受影响",
     scrTip: "逐字阅读(刮刮乐): 正文涂层隐藏如刮刮乐, 鼠标划过逐个字显现; Esc退出", scrAria: "逐字阅读", scrNoBook: "先打开一本书再开启逐字阅读", scrRatioLabel: "抹黑比例", scrRatioAria: "抹黑比例", scrRatioNumAria: "抹黑比例数值", scrRatioMinusTip: "减小刮乐涂层比例", scrRatioPlusTip: "增大刮乐涂层比例", scrRatioHint: "逐字阅读(刮刮乐)模式下被涂层隐藏的文字比例：0 = 无涂层(关闭)，100 = 全部涂层；默认 50。",
    secWidth: "正文宽度",
    ...
    /* 生词面板 */
    tabVocab: "生词", vocabRangeAll: "全书", vocabRangeChapter: "当前章", vocabRangeUnit: "导航单元",
    vocabAnalyzing: "分析中…", vocabNoBook: "先打开一本书再查看生词", vocabEmpty: "当前范围没有检出生词",
    vocabRangeAria: "生词统计范围",
    vocabTotalChars: "汉字总数", vocabPairs: "二字词次", vocabUniquePairs: "不同二字词", vocabNewWords: "生词数",
    /* 欢迎页 */
    ...
    shelfSaveFail: "书架保存失败，存储空间可能不足",
    shelfUnavailable: "本地存储暂不可用，无法保存阅读进度",
    ...
    imagesPacking: "正在打包书内图片…",
    imagesExported: "已导出 {0} 张图片",
    noImages: "本书没有发现图片",
    imagesExportFail: "图片导出失败",
  ...
  en: {
    ...
    closeBook: "Close book", exportImages: "Extract this book's images",
    ...
    pinyinLabel: "Annotation", pinyinAria: "Annotation mode", annOff: "Off", annPinyin: "Pinyin", annRomaji: "Romaji", annPyOnly: "Pinyin only", pinyinSessionTip: "Pinyin annotates Chinese characters, romaji annotates Japanese kana (book furigana converted too), pinyin-only replaces Chinese text with plain pinyin; built-in annotations stay intact. Not persisted, re-enable each session.", pinyinNativeRuby: "This book has its own annotations; overlay pinyin will not override them", pinyinLoadFail: "Failed to load the annotation library, please check your network and retry",     pinyinTooLong: "Text too long; annotation was skipped for some parts", twTip: "Typing mode: letters only (English words · Chinese pinyin · Japanese romaji); typing drives reading; Esc to exit, Tab to skip", twAria: "Typing mode", twNoVert: "Typing mode is not supported in vertical layout yet", twPickHint: "Click a paragraph to start typing (Esc to exit)", twBarHint: "Typing", twPh: "Type letters here…", twChapDone: "Chapter typed to the end", twStatPick: "Pick a paragraph to start", twModeLabel: "Chinese input style", twModeAria: "Chinese typing mode", twModePinyin: "Pinyin match", twModeReal: "Real IME typing", twModeHint: "Pinyin match: type letters with IME off; Real IME: compose normally and commit hanzi — matched against the original text. English words are typed directly.", sndLabel: "Typing sound", sndAria: "Toggle typing sound", sndTip: "Play key sounds in typing mode, error buzz on mistakes", sndHint: "Plays a key sound per letter and an error buzz on mistakes in typing mode; preference is saved and included in backups.", mkTip: "Marker highlight: sweep text to mark, click a highlight to remove", mkAria: "Marker highlight", mkDel: "Delete this highlight?", mkDeleted: "Highlight deleted", bookFontAria: "Prefer book fonts", chapFailTitle: "Chapter unavailable", chapFailBody: "This chapter's file is missing or corrupted; other chapters are unaffected.",
    scrTip: "Scratch reveal: text is hidden under a coating; sweep the mouse to reveal it character by character; Esc to exit", scrAria: "Scratch reveal", scrNoBook: "Open a book first to enable scratch reveal", scrRatioLabel: "Coating ratio", scrRatioAria: "Coating ratio", scrRatioNumAria: "Coating ratio value", scrRatioMinusTip: "Decrease coating ratio", scrRatioPlusTip: "Increase coating ratio", scrRatioHint: "Percentage of characters hidden under coating in scratch reveal mode: 0 = no coating (off), 100 = all coated; default 50.",
    ...
    langAuto: "Auto",
    tabToc: "Contents", tabSearch: "Search", tabMindMap: "Map", tabVocab: "Words",
    ...
    vocabRangeAll: "Whole book", vocabRangeChapter: "This chapter", vocabRangeUnit: "This unit",
    vocabAnalyzing: "Analyzing…", vocabNoBook: "Open a book first to view vocabulary", vocabEmpty: "No new words found in the current range",
    vocabRangeAria: "Vocabulary analysis range",
    vocabTotalChars: "Han chars", vocabPairs: "Bigram uses", vocabUniquePairs: "Unique bigrams", vocabNewWords: "New words",
    ...
    shelfSaveFail: "Failed to save to library — storage may be full",
    shelfUnavailable: "Local storage unavailable — reading progress won't be saved",
    ...
    imagesPacking: "Packing images…",
    imagesExported: "Exported {0} images",
    noImages: "No images found in this book",
    imagesExportFail: "Image export failed",
