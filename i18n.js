...
const I18N_STRINGS = {
  zh: {
    ...
    secCustom: "自定义主题",
    ctBgLabel: "正文背景", ctFgLabel: "文字颜色", ctUiLabel: "界面底色",
    colorAriaBg: "自定义正文背景色", colorAriaFg: "自定义文字颜色", colorAriaUi: "自定义界面底色",
    ctReset: "重置本槽为初始配色", customSlotN: "自定义{0}",
    advMore: "更多颜色", advAutoTitle: "恢复自动派生",
    advFg: "界面文字", advMuted: "次要文字", advBar: "顶栏", advBorder: "边框", advButton: "按钮", advAccent: "强调色",
    advFgAria: "界面文字颜色", advMutedAria: "次要文字颜色", advBarAria: "顶栏颜色", advBorderAria: "边框颜色", advButtonAria: "按钮颜色", advAccentAria: "强调色",
    secType: "排版",
    ...
    bookFontLabel: "书籍字体优先", bookFontAria: "书籍字体优先",
    secWidth: "正文宽度",
  ...
  en: {
    ...
    ctBgLabel: "Text background", ctFgLabel: "Text color", ctUiLabel: "Interface color",
    colorAriaBg: "Custom text background color", colorAriaFg: "Custom text color", colorAriaUi: "Custom interface color",
    ctReset: "Reset slot to initial colors", customSlotN: "Custom {0}",
    advMore: "More colors", advAutoTitle: "Back to auto",
    advFg: "Interface text", advMuted: "Muted text", advBar: "Top bar", advBorder: "Borders", advButton: "Buttons", advAccent: "Accent",
    advFgAria: "Interface text color", advMutedAria: "Muted text color", advBarAria: "Top bar color", advBorderAria: "Border color", advButtonAria: "Button color", advAccentAria: "Accent color",
    secType: "Typography",
    ...
    bookFontLabel: "Prefer book fonts", bookFontAria: "Prefer book fonts",
