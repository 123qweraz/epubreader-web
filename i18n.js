...
const I18N_STRINGS = {
  zh: {
    ...
    pinyinLabel: "拼音标注", pinyinAria: "开启拼音标注", pinyinTip: "为无注音的汉字外挂拼音标注; 会话级开关, 重启应用后需重新开启", pinyinSessionTip: "外挂注音不影响书籍自带注音的显示; 开启状态不做持久化, 每次打开应用需重新开启。", pinyinNativeRuby: "本书自带注音，外挂注音不会覆盖已有注音", pinyinLoadFail: "注音库加载失败, 请检查网络后重试", pinyinTooLong: "文本过长, 部分内容已跳过拼音标注", bookFontAria: "书籍字体优先", chapFailTitle: "本章无法显示", chapFailBody: "该章节文件缺失或已损坏，其余章节不受影响",
    secWidth: "正文宽度",
  ...
  en: {
    ...
    pinyinLabel: "Pinyin", pinyinAria: "Toggle pinyin annotation", pinyinTip: "Overlay pinyin for characters without annotations; session-only toggle, re-enable after restarting the app", pinyinSessionTip: "Overlay pinyin does not affect annotations built into the book; the toggle is not persisted, re-enable each session.", pinyinNativeRuby: "This book has its own annotations; overlay pinyin will not override them", pinyinLoadFail: "Failed to load the pinyin library, please check your network and retry", pinyinTooLong: "Text too long; pinyin was skipped for some parts", bookFontAria: "Prefer book fonts", chapFailTitle: "Chapter unavailable", chapFailBody: "This chapter's file is missing or corrupted; other chapters are unaffected.",
