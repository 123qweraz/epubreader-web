...
const I18N_STRINGS = {
  zh: {
    ...
    tabAppearance: "外观", tabLayout: "排版", tabBackup: "备份", secBackup: "数据备份",
    ...
    pinyinLabel: "拼音标注", pinyinAria: "开启拼音标注", pinyinTip: "在汉字上方标注拼音; 首次开启需联网加载注音库, 之后离线可用", pinyinLoadFail: "注音库加载失败, 请检查网络后重试", pinyinTooLong: "文本过长, 部分内容已跳过拼音标注", bookFontAria: "书籍字体优先",
    secWidth: "正文宽度",
  ...
  en: {
    ...
    tabAppearance: "Appearance", tabLayout: "Layout", tabBackup: "Backup", secBackup: "Data backup",
    ...
    pinyinLabel: "Pinyin", pinyinAria: "Toggle pinyin annotation", pinyinTip: "Show pinyin above Chinese characters; the annotation library is fetched online on first use, offline afterwards", pinyinLoadFail: "Failed to load the pinyin library, please check your network and retry", pinyinTooLong: "Text too long; pinyin was skipped for some parts", bookFontAria: "Prefer book fonts",
