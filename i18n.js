...
const I18N_STRINGS = {
  ...
  en: {
    ...
    pinyinLabel: "Annotation", pinyinAria: "Annotation mode", annOff: "Off", annPinyin: "Pinyin", annRomaji: "Romaji", pinyinSessionTip: "Pinyin annotates Chinese characters, romaji annotates Japanese kana (book-provided furigana converted too); built-in annotations are untouched. Not persisted, re-enable each session.", pinyinNativeRuby: "This book has its own annotations; overlay pinyin will not override them", pinyinLoadFail: "Failed to load the annotation library, please check your network and retry", pinyinTooLong: "Text too long; annotation was skipped for some parts", bookFontAria: "Prefer book fonts", chapFailTitle: "Chapter unavailable", chapFailBody: "This chapter's file is missing or corrupted; other chapters are unaffected.",
